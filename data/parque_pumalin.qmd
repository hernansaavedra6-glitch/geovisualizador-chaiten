...
<qgis version="3.44.8-Solothurn">
  <identifier>sde.SDE.Areas_Protegidas</identifier>
  <parentidentifier></parentidentifier>
  <language>EN</language>
  <type>dataset</type>
  <title>sde.SDE.Areas_Protegidas</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" type="ArcSDE Connection" url="Server=172.22.110.36; Service=5151; Database=sde; User=geosde; Version=SDE.DEFAULT" mimeType="" size="" format="" name="SDE Feature Class"/>
  </links>
  <dates/>
  <fees></fees>
